...
/**
 * Created by Steev on 12/06/2017.
 */
        ...
        try {
            ...
            for (int i = 0; i < newsItemArray.length(); i++) {
                ...
                if(volumeInfo.has("infoLink")) {
                    ...
                    selectedNews = volumeInfo.getString("infoLink");
                }
                ...
                NewsItem newsItem = new NewsItem(thumbnailImage, title, author, selectedNews);
